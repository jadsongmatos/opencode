# External tests for slash-popover.tsx

**Arquivo:** `packages/app/src/components/prompt-input/slash-popover.tsx`
...
**Consultas usadas no Horsebox:** `Component`, `solid-js Component`, `For`, `solid-js For`, `Match`, `solid-js Match`, `Show`, `solid-js Show`, `Switch`, `solid-js Switch`

**Arquivos de teste encontrados:** 56
...
#### should create a conditional function

```ts
test('should create a conditional function', function(assert) {
      assert.expect(3);
...
#### `_.' + methodName + '` should match `NaN`

```ts
test('`_.' + methodName + '` should match `NaN`', function(assert) {
      assert.expect(1);
...
#### should work with `_.matches` shorthands

```ts
test('should work with `_.matches` shorthands', function(assert) {
      assert.expect(1);
...
#### should work with `_.matchesProperty` shorthands

```ts
test('should work with `_.matchesProperty` shorthands', function(assert) {
      assert.expect(1);
...
#### `_.' + methodName + '` should work with `_.matches` shorthands

```ts
test('`_.' + methodName + '` should work with `_.matches` shorthands', function(assert) {
      assert.expect(1);
...
#### `_.' + methodName + '` should work with `_.matchesProperty` shorthands

```ts
test('`_.' + methodName + '` should work with `_.matchesProperty` shorthands', function(assert) {
      assert.expect(1);
...
```ts
test('should match `NaN`', function(assert) {
      assert.expect(1);
...
```ts
test('should match `-0` as `0`', function(assert) {
      assert.expect(2);
...
#### should handle comparisons when `customizer` returns `undefined`

```ts
test('should handle comparisons when `customizer` returns `undefined`', function(assert) {
      assert.expect(1);
...
#### should ensure `customizer` is a function

```ts
test('should ensure `customizer` is a function', function(assert) {
      assert.expect(1);
...
#### should return an iteratee created by `_.matches` when `func` is an object

```ts
test('should return an iteratee created by `_.matches` when `func` is an object', function(assert) {
      assert.expect(2);
...
#### should not change `_.matches` behavior if `source` is modified

```ts
test('should not change `_.matches` behavior if `source` is modified', function(assert) {
      assert.expect(9);
...
#### should return an iteratee created by `_.matchesProperty` when `func` is an array

```ts
test('should return an iteratee created by `_.matchesProperty` when `func` is an array', function(assert) {
      assert.expect(3);
...
#### should not change `_.matchesProperty` behavior if `source` is modified

```ts
test('should not change `_.matchesProperty` behavior if `source` is modified', function(assert) {
      assert.expect(9);
...
#### should differentiate between `_.property` and `_.matchesProperty` shorthands

```ts
test('should differentiate between `_.property` and `_.matchesProperty` shorthands', function(assert) {
      assert.expect(2);
...
```ts
test('should match lone surrogates', function(assert) {
      assert.expect(3);
...
```ts
test('should match words containing Latin Unicode letters', function(assert) {
      assert.expect(1);
...
### ../../.sbomtest/repos/f3c62de455-express/test/req.stale.js
...
#### reports matched route via nagivate

```ts
test('reports matched route via nagivate', function(assert) {
    assert.expect(1);
...
```ts
test('routes (anything)', function(assert) {
    assert.expect(1);
...
```ts
test('No hash fallback.', function(assert) {
    assert.expect(0);
    Backbone.history.stop();
...
```ts
test('matches with predicate', function(assert) {
...
```ts
test('multiple unsets', function(assert) {
    assert.expect(1);
    var i = 0;
...
#### unset does not fire a change for undefined attributes

```ts
test('unset does not fire a change for undefined attributes', function(assert) {
    assert.expect(0);
...
**Consultas usadas no Horsebox:** `getDirectory`, `@opencode-ai/core/util/path getDirectory`, `opencode-ai/core/util/path getDirectory`, `path getDirectory`, `getFilename`, `@opencode-ai/core/util/path getFilename`, `opencode-ai/core/util/path getFilename`, `path getFilename`
