# External tests for context-items.tsx

**Arquivo:** `packages/app/src/components/prompt-input/context-items.tsx`
...
**Consultas usadas no Horsebox:** `getDirectory`, `@opencode-ai/core/util/path getDirectory`, `opencode-ai/core/util/path getDirectory`, `path getDirectory`, `getFilename`, `@opencode-ai/core/util/path getFilename`, `opencode-ai/core/util/path getFilename`, `path getFilename`, `getFilenameTruncated`, `@opencode-ai/core/util/path getFilenameTruncated`, `opencode-ai/core/util/path getFilenameTruncated`, `path getFilenameTruncated`
