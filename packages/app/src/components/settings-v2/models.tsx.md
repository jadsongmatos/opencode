# External tests for models.tsx

**Arquivo:** `packages/app/src/components/settings-v2/models.tsx`

## Checklist

- [ ] @opencode-ai/ui/hooks
- [ ] @opencode-ai/ui/provider-icon
- [ ] @opencode-ai/ui/v2/switch-v2
...
**Consultas usadas no Horsebox:** `useFilteredList`, `@opencode-ai/ui/hooks useFilteredList`, `opencode-ai/ui/hooks useFilteredList`, `hooks useFilteredList`
...
**Consultas usadas no Horsebox:** `Switch`, `@opencode-ai/ui/v2/switch-v2 Switch`, `opencode-ai/ui/v2/switch-v2 Switch`, `switch-v2 Switch`

**Arquivos de teste encontrados:** 3

### ../../.sbomtest/repos/901466a5bb-lodash/vendor/backbone/test/model.js

#### nested set triggers with the correct options

```ts
test('nested set triggers with the correct options', function(assert) {
...
#### nested `set` during `'change'`

```ts
test("nested `set` during `'change'`", function(assert) {
    assert.expect(6);
    var count = 0;
    var model = new Backbone.Model();
...
```ts
test('nested `change` with silent', function(assert) {
    assert.expect(3);
    var count = 0;
    var model = new Backbone.Model();
...
#### should create a function that accepts multiple arguments

```ts
test('should create a function that accepts multiple arguments', function(assert) {
      assert.expect(1);
...
```ts
test('should return an array', function(assert) {
      assert.expect(70);
...
**Consultas usadas no Horsebox:** `useModels`, `@/context/models useModels`, `/context/models useModels`, `models useModels`
...
**Consultas usadas no Horsebox:** `indexOf`, `@/hooks/use-providers indexOf`, `/hooks/use-providers indexOf`, `use-providers indexOf`, `popularProviders`, `@/hooks/use-providers popularProviders`, `/hooks/use-providers popularProviders`, `use-providers popularProviders`
...
#### should work with `fp.indexOf`

```ts
test('should work with `fp.indexOf`', function(assert) {
      assert.expect(10);
...
**Consultas usadas no Horsebox:** `SettingsListV2`, `./parts/list SettingsListV2`, `list SettingsListV2`

**Arquivos de teste encontrados:** 24
...
### ../../.sbomtest/repos/f3c62de455-express/test/acceptance/route-map.js
...
### ../../.sbomtest/repos/f3c62de455-express/test/acceptance/error-pages.js
...
```ts
test('listenTo and stopListening', function(assert) {
    assert.expect(1);
...
```ts
test('listenTo and stopListening with event maps', function(assert) {
    assert.expect(4);
    var a = _.extend({}, Backbone.Events);
    var b = _.extend({}, Backbone.Events);
...
```ts
test('stopListening with omitted args', function(assert) {
    assert.expect(2);
    var a = _.extend({}, Backbone.Events);
    var b = _.extend({}, Backbone.Events);
    var cb = function() { assert.ok(true); };
...
#### listenToOnce and stopListening

```ts
test('listenToOnce and stopListening', function(assert) {
    assert.expect(1);
    var a = _.extend({}, Backbone.Events);
    var b = _.extend({}, Backbone.Events);
...
```ts
test('listenTo, listenToOnce and stopListening', function(assert) {
    assert.expect(1);
    var a = _.extend({}, Backbone.Events);
    var b = _.extend({}, Backbone.Events);
    a.listenToOnce(b, 'all', function() { assert.ok(true); });
...
```ts
test('listenTo yourself', function(assert) {
    assert.expect(1);
...
#### listenTo yourself cleans yourself up with stopListening

```ts
test('listenTo yourself cleans yourself up with stopListening', function(assert) {
    assert.expect(1);
    var e = _.extend({}, Backbone.Events);
    e.listenTo(e, 'foo', function(){ assert.ok(true); });
    e.trigger('foo');
...
#### stopListening cleans up references

```ts
test('stopListening cleans up references', function(assert) {
    assert.expect(12);
    var a = _.extend({}, Backbone.Events);
    var b = _.extend({}, Backbone.Events);
    var fn = function() {};
...
#### stopListening cleans up references from listenToOnce

```ts
test('stopListening cleans up references from listenToOnce', function(assert) {
    assert.expect(12);
    var a = _.extend({}, Backbone.Events);
    var b = _.extend({}, Backbone.Events);
    var fn = function() {};
...
#### listenTo and off cleaning up references

```ts
test('listenTo and off cleaning up references', function(assert) {
    assert.expect(8);
    var a = _.extend({}, Backbone.Events);
    var b = _.extend({}, Backbone.Events);
    var fn = function() {};
...
#### listenTo and stopListening cleaning up references

```ts
test('listenTo and stopListening cleaning up references', function(assert) {
    assert.expect(2);
    var a = _.extend({}, Backbone.Events);
    var b = _.extend({}, Backbone.Events);
    a.listenTo(b, 'all', function(){ assert.ok(true); });
...
#### listenToOnce with event maps cleans up references

```ts
test('listenToOnce with event maps cleans up references', function(assert) {
    assert.expect(2);
    var a = _.extend({}, Backbone.Events);
    var b = _.extend({}, Backbone.Events);
    a.listenToOnce(b, {
...
#### listenTo with empty callback doesn't throw an error

```ts
test("listenTo with empty callback doesn't throw an error", function(assert) {
    assert.expect(1);
    var e = _.extend({}, Backbone.Events);
...
#### callback list is not altered during trigger

```ts
test('callback list is not altered during trigger', function(assert) {
    assert.expect(2);
...
```ts
test("#1282 - 'all' callback list is retrieved after each event.", function(assert) {
    assert.expect(1);
    var counter = 0;
...
#### listenToOnce without a callback is a noop

```ts
test('listenToOnce without a callback is a noop', function(assert) {
    assert.expect(0);
    var obj = _.extend({}, Backbone.Events);
...
#### event functions are chainable

```ts
test('event functions are chainable', function(assert) {
    var obj = _.extend({}, Backbone.Events);
...
#### #3448 - listenToOnce with space-separated events

```ts
test('#3448 - listenToOnce with space-separated events', function(assert) {
    assert.expect(2);
...
### ../../.sbomtest/repos/f3c62de455-express/test/acceptance/mvc.js
...
```ts
test('routes (splats)', function(assert) {
    assert.expect(1);
...
#### `_.' + methodName + '` should treat sparse arrays as dense

```ts
test('`_.' + methodName + '` should treat sparse arrays as dense', function(assert) {
        assert.expect(1);
