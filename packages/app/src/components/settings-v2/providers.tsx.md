# External tests for providers.tsx

**Arquivo:** `packages/app/src/components/settings-v2/providers.tsx`

## Checklist

- [ ] @opencode-ai/ui/v2/button-v2
- [ ] @opencode-ai/ui/v2/badge-v2
...
**Consultas usadas no Horsebox:** `Tag`, `@opencode-ai/ui/v2/badge-v2 Tag`, `opencode-ai/ui/v2/badge-v2 Tag`, `badge-v2 Tag`
...
**Consultas usadas no Horsebox:** `indexOf`, `@/hooks/use-providers indexOf`, `/hooks/use-providers indexOf`, `use-providers indexOf`, `popularProviders`, `@/hooks/use-providers popularProviders`, `/hooks/use-providers popularProviders`, `use-providers popularProviders`, `useProviders`, `@/hooks/use-providers useProviders`, `/hooks/use-providers useProviders`, `use-providers useProviders`
...
**Consultas usadas no Horsebox:** `createMemo`, `solid-js createMemo`, `Component`, `solid-js Component`, `For`, `solid-js For`, `Show`, `solid-js Show`
