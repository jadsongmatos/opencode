# External tests for session-sortable-tab.tsx

**Arquivo:** `packages/app/src/components/session/session-sortable-tab.tsx`
...
**Consultas usadas no Horsebox:** `createMemo`, `solid-js createMemo`, `Show`, `solid-js Show`, `JSX`, `solid-js JSX`
...
**Consultas usadas no Horsebox:** `useFile`, `@/context/file useFile`, `/context/file useFile`, `file useFile`
