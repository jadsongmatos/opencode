# External tests for server-row.tsx

**Arquivo:** `packages/app/src/components/server/server-row.tsx`
...
**Consultas usadas no Horsebox:** `children`, `solid-js children`, `createEffect`, `solid-js createEffect`, `createMemo`, `solid-js createMemo`, `createSignal`, `solid-js createSignal`, `JSXElement`, `solid-js JSXElement`, `onMount`, `solid-js onMount`, `ParentProps`, `solid-js ParentProps`, `Show`, `solid-js Show`
...
**Consultas usadas no Horsebox:** `ServerConnection`, `@/context/server ServerConnection`, `/context/server ServerConnection`, `server ServerConnection`, `serverName`, `@/context/server serverName`, `/context/server serverName`, `server serverName`
